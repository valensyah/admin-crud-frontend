...
export default function Register() {
    const {
      ...
      const onSubmit: SubmitHandler<Inputs> = async (data) => {
        if (data) {
            axiosInstance.post('/users/create', data).then(res => {
                if (res.data.success) {
                    router.push('/login')
                } else {
    ...
    return (
        <div className="w-full h-screen flex justify-center items-center">
            <div className="card bg-white shadow-md rounded-2xl w-4/12 h-fit p-5">
                <p className="text-xl font-semibold text-center mb-5">Registrasi</p>
                <form onSubmit={handleSubmit(onSubmit)} className="flex w-full flex-col gap-4">
                    ...
                    <div>
                        ...
                        <TextInput id="first_name" {...register("first_name", { required: 'Nama depan tidak boleh kosong!'})} type="text" placeholder="" required/>
                    ...
                    <div>
                        ...
                        <TextInput id="last_name" {...register("last_name")} type="text" placeholder=""/>
                    ...
                    <div>
                        ...
                        <TextInput id="birth_date" {...register("birth_date", { required: "Tanggal Lahir tidak boleh kosong!" })} type="date" placeholder=""/>
                    ...
                    <div className="max-w-md">
                        ...
                        <Select id="gender" { ...register('gender', {required: 'Jenis kelamin tidak boleh kosong!'}) } required>
